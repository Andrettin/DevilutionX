...
local events = {
  ...
  ---Called after the class data TSV file has been loaded.
  ClassDataLoaded = CreateEvent(),
  __doc_ClassDataLoaded = "Called after the class data TSV file has been loaded.",
